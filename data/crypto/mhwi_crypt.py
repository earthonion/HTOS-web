        ...
        async def generate_checksum(self, offset: int, length: int, saveslot: int) -> bytes:
            ...
            uStack_88 = (
                int(
                    (
                        Crypt_Mhwi.FLOATS[
                            (Crypt_Mhwi.BLOWFISH_SBOX[auStack_58[0] & 0xFFF] + auStack_58[0])
                            & 0xFFF
                        ]
                        - 0.5
                    )
            ...
            auStack_c8 = [0] * 4
            for i in range(4):
                auStack_c8[i] = auStack_a8[i] ^ auStack_58[i] ^ auStack_68[3] ^ auStack_a8[7]
