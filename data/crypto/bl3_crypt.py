...
class Crypt_BL3:
    SAVEGAME_STRING_BL3 = b"OakSaveGame"
    PROFILE_STRING_BL3 = b"BP_DefaultOakProfile_C"

    SAVEGAME_STRING_TTWL = b"BPSaveGame_Default_C"
    PROFILE_STRING_TTWL = b"OakProfile"
    ...
    KEYS_PROFILE = {
        "ps4": {"pre": PS4_PROFILE_PREFIX_MAGIC, "xor": PS4_PROFILE_XOR_MAGIC},
        "pc": {"pre": PC_PROFILE_PREFIX_MAGIC, "xor": PC_PROFILE_XOR_MAGIC},
    }

    KEYS_SAVEGAME = {
        "ps4": {"pre": PS4_PREFIX_MAGIC, "xor": PS4_XOR_MAGIC},
        "pc": {"pre": PC_PREFIX_MAGIC, "xor": PC_XOR_MAGIC},
    }

    IDENTIFIER_STRINGS = {
        "BL3": {"profile": PROFILE_STRING_BL3, "savegame": SAVEGAME_STRING_BL3},
        "TTWL": {"profile": PROFILE_STRING_TTWL, "savegame": SAVEGAME_STRING_TTWL},
    }
    ...
    async def decrypt_file(
        filepath: str, platform: Literal["ps4", "pc"], ttwl: bool = False
    ) -> None:
