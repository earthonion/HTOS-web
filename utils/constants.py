...
def setup_logger(path: str, logger_type: str, level: str) -> logging.Logger:
    ...
    _logger = logging.getLogger(logger_type)
...
blacklist_logger = setup_logger(
    os.path.join("logs", "BLACKLIST.log"), "BLACKLIST_LOGS", "INFO"
)

# CONFIG
STORED_SAVES_FOLDER = str(os.getenv("STORED_SAVES_FOLDER_PATH", "STORAGE"))
...
RDR2_TITLEID = frozenset(
    ["CUSA03041", "CUSA08519", "CUSA08568", "CUSA15698", "CUSA11081"]
)
XENO2_TITLEID = frozenset(
    ["CUSA05350", "CUSA05088", "CUSA04904", "CUSA05085", "CUSA05774"]
)
...
NDOG_COL_TITLEID = frozenset(
    ["CUSA02344", "CUSA02343", "CUSA02826", "CUSA02320", "CUSA01399"]
)
...
DI1_TITLEID = frozenset(
    ["CUSA03291", "CUSA03290", "CUSA03684", "CUSA03685", "CUSA05688"]
)
...
MAX_FILES = 100
UPLOAD_TIMEOUT = minutes_to_seconds(10)
OTHER_TIMEOUT = minutes_to_seconds(5)
GENERAL_TIMEOUT = hours_to_seconds(1)
GENERAL_CHUNKSIZE = mb_to_bytes(32)
COMMAND_COOLDOWN = 30
ZIPFILE_COMPRESSION_MODE = ZIP_STORED
ZIPFILE_COMPRESSION_LEVEL = None
CREATESAVE_ENC_CHECK_LIMIT = 20
...
FILE_LIMIT_DISCORD = mb_to_bytes(500)  # kept for orbis.py compatibility
